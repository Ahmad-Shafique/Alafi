...
-- insert into Supplier (id, Name, Email, CreditInRupees, CreditInDinars, DebitInRupees, DebitInDinars, ProfitsInRupees, ProfitsInDinar, DateAdded) values (1, 'Ransom Feyer', 'rfeyer0@diigo.com', 20.008, 39.685, 35.249, 92.609, 38.267, 64.277, '7/25/2018');
-- insert into Supplier (id, Name, Email, CreditInRupees, CreditInDinars, DebitInRupees, DebitInDinars, ProfitsInRupees, ProfitsInDinar, DateAdded) values (2, 'Demetrius Amar', 'damar1@free.fr', 35.17, 32.779, 67.376, 78.121, 24.46, 90.37, '2/12/2018');
...
-- insert into Customers (id, Name, MobileNumber, TotalPurchaseInDinars, CreditAmountInDinars) values (1, 'Cecile Hixley', '6836728411', 48.341, 15.147);
-- insert into Customers (id, Name, MobileNumber, TotalPurchaseInDinars, CreditAmountInDinars) values (2, 'Milly Fessby', '8516309282', 71.868, 78.863);
...
-- insert into Staff (id, Name, CivilIdNumber, CivilIdExpiry, Photo, DateAdded, LastModifiedDate, LastModifiedID, AddedById, Designation, BranchId) values (1, 'Vivien Janowski', 12, '9/28/2018', 'http://dummyimage.com/215x140.bmp/cc0000/ffffff', '2/21/2018', '1/13/2018', 1, 1, 'Support', 1);
-- insert into Staff (id, Name, CivilIdNumber, CivilIdExpiry, Photo, DateAdded, LastModifiedDate, LastModifiedID, AddedById, Designation, BranchId) values (2, 'Klarika Swindin', 12, '2/5/2018', 'http://dummyimage.com/134x182.png/ff4444/ffffff', '12/19/2017', '11/23/2017', 2, 2, 'Sales', 2);
...
-- insert into Branches (Id, Name, Address, TotalProfitInDinars, BranchManagerId, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (1, 'Geraldine Welbrock', '2969 Truax Point', 1.223, 1, '12/23/2017', 1, '2/6/2018', 1);
-- insert into Branches (Id, Name, Address, TotalProfitInDinars, BranchManagerId, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (2, 'Rora Caizley', '62 Schurz Circle', 7.563, 2, '9/22/2018', 2, '5/16/2018', 2);
...
-- insert into BrancheSaleTransactions (Id, BranchId, CustomerId, Date, TotalProfit, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (1, 1, 1, '4/11/2018', 4.164, '12/31/2017', 1, '4/3/2018', 1);
-- insert into BrancheSaleTransactions (Id, BranchId, CustomerId, Date, TotalProfit, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (2, 2, 2, '9/17/2018', 32.039, '2/12/2018', 2, '4/16/2018', 2);
...
-- insert into BranchExpenseTransactions (Id, AmountInDinars, Reason, BranchId, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (1, 3.392, 'amet  integer ac leo', 1, '11/22/2017', 1, '12/11/2017', 1);
-- insert into BranchExpenseTransactions (Id, AmountInDinars, Reason, BranchId, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (2, 2.913, 'et eros vestibulum ac est lacinia nisi venenatis tristique fusce congue diam id ornare', 2, '6/17/2018', 2, '9/4/2018', 2);
...
-- insert into Shipments (Id, SupplierId, ShipmentNumber, ExpectedArrivalDate, ExpectedDeliveryDate, ExpectedArrivalPlace, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (1, 1, 'odio porttitor id', '10/30/2017', '6/6/2018', '168 Bartelt Hill', '8/2/2018', 1, '8/28/2018', 1);
-- insert into Shipments (Id, SupplierId, ShipmentNumber, ExpectedArrivalDate, ExpectedDeliveryDate, ExpectedArrivalPlace, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (2, 2, 'non mattis pulvinar nulla pede ullamcorper augue a suscipit nulla elit ac nulla sed vel enim sit amet nunc viverra', '4/23/2018', '10/3/2018', '0 Toban Alley', '12/23/2017', 2, '10/28/2017', 2);
...
-- insert into Items (Id, Name, DateAdded, AddedById, LastModifiedDate, LastModifiedID) values (2, 2, '5/11/2018', 2, '9/19/2018', 2);
...
-- insert into RevaluationHistory (Id, ItemId, OriginalUnitPrice, RevaluatedPrice, DateAdded, AddedById) values (1, 1, 4.289, 4.272, '5/22/2018', 1);
-- insert into RevaluationHistory (Id, ItemId, OriginalUnitPrice, RevaluatedPrice, DateAdded, AddedById) values (2, 2, 3.78, 2.684, '9/11/2018', 2);
...
-- insert into RevaluationProfits (Id, ItemId, OriginalUnitPrice, NewUnitPrice, TotalAmount, Profit, DateAdded, AddedById) values (1, 1, 1.767, 1.142, 5.439, 6.306, '12/2/2017', 1);
-- insert into RevaluationProfits (Id, ItemId, OriginalUnitPrice, NewUnitPrice, TotalAmount, Profit, DateAdded, AddedById) values (2, 2, 2.034, 1.821, 7.39, 9.239, '2/11/2018', 2);
...
-- insert into ItemSalesRecord (Id, ItemId, ShipmentNumber, WholeSaleTotalQuantity, WholeSaleTotalPrice, RetailSaleTotalQuantity, RetailSaleTotalPrice, RevaluationProfit, RevaluationLoss, DateAdded, AddedById, LastModifiedDate, LastModifiedId) values (1, 1, 'actuating', 7.567, 4.668, 6.497, 9.0, 5.181, 9.33, '4/22/2018', 1, '12/25/2017', 1);
-- insert into ItemSalesRecord (Id, ItemId, ShipmentNumber, WholeSaleTotalQuantity, WholeSaleTotalPrice, RetailSaleTotalQuantity, RetailSaleTotalPrice, RevaluationProfit, RevaluationLoss, DateAdded, AddedById, LastModifiedDate, LastModifiedId) values (2, 2, 'asymmetric', 1.755, 8.167, 1.225, 5.241, 4.376, 5.408, '1/30/2018', 2, '5/2/2018', 2);
